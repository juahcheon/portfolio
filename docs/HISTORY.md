...
| **4. PR 메시지 초안** | Cursor | 커밋 후 `.github/pull_request_template.md` 형식으로 PR 제목·본문 초안을 작성해 제시. **PR 생성·push·merge 금지** |
...
- 메시지: `docs: 1인 브랜치 전략 및 Cursor 커밋 4단계 정리`

승인해 주시면 위 순서로 커밋하고, 커밋 후 PR 메시지 초안을 작성합니다. (push와 PR 생성은 하지 않습니다)
```
